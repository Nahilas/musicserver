...
module.exports = {};
},{"./audioplayer.js":3,"./library.js":8,"./playlist.js":11,"./util.js":19}],3:[function(require,module,exports){
var $jPlayer, 
	isPlaying = false, 
	currentItem = null,
...
},{"./vendor/signals.min.js":24}],4:[function(require,module,exports){
...
},{"./../api.js":1,"./../library.js":8,"./../templates/dialog-artist-bio.js":13,"./../vendor/lodash.min.js":21,"./dialog.js":5}],5:[function(require,module,exports){
...
},{"./../api.js":1,"./../templates/dialog-login.js":14,"./dialog.js":5}],7:[function(require,module,exports){
...
},{"./audiocontrols.js":2,"./dialogs/login.js":6,"./library.js":8,"./metadata.js":9,"./navigation.js":10,"./responsive.js":12}],8:[function(require,module,exports){
...
},{"./api.js":1,"./vendor/lodash.min.js":21}],9:[function(require,module,exports){
var $metadata,
	library = require('./library.js');
...
},{"./library.js":8}],10:[function(require,module,exports){
...
},{"./api.js":1,"./dialogs/artist-bio.js":4,"./library.js":8,"./playlist.js":11,"./templates/navigation-album.js":15,"./templates/navigation-artist-buttons.js":16,"./templates/navigation-default.js":17,"./vendor/lodash.min.js":21}],11:[function(require,module,exports){
...
},{"./api.js":1,"./audioplayer.js":3,"./templates/playlist-item.js":18,"./util.js":19,"./vendor/lodash.min.js":21,"./vendor/moment.js":22,"./vendor/mousetrap.min.js":23}],12:[function(require,module,exports){
...
},{"./../vendor/jaderuntime.js":20}],14:[function(require,module,exports){
jade = require("./../vendor/jaderuntime.js");function template(locals) {
var buf = [];
var jade_mixins = {};
...
},{"./../vendor/jaderuntime.js":20}],15:[function(require,module,exports){
jade = require("./../vendor/jaderuntime.js");function template(locals) {
var buf = [];
var jade_mixins = {};
var locals_ = (locals || {}),cover = locals_.cover,name = locals_.name,year = locals_.year,items = locals_.items;
buf.push("<li class=\"album\"><div class=\"row\"><div class=\"col-xs-4 cover\"><img" + (jade.attr("src", (cover || '/images/no-cover.png'), true, false)) + "/></div><div class=\"col-xs-8 info\"><h3>" + (jade.escape(null == (jade.interp = name) ? "" : jade.interp)) + "</h3><h5>" + (jade.escape(null == (jade.interp = year) ? "" : jade.interp)) + "</h5><h5>" + (jade.escape(null == (jade.interp = (items.length + " songs")) ? "" : jade.interp)) + "</h5><div class=\"btn-group\"><button class=\"btn btn-default play\"><span class=\"glyphicon glyphicon-play\"></span></button><button class=\"btn btn-default add\"><span class=\"glyphicon glyphicon-log-in\"></span></button></div></div></div></li>");;return buf.join("");
}module.exports = template;
},{"./../vendor/jaderuntime.js":20}],16:[function(require,module,exports){
jade = require("./../vendor/jaderuntime.js");function template(locals) {
var buf = [];
var jade_mixins = {};
...
},{"./../vendor/jaderuntime.js":20}],17:[function(require,module,exports){
jade = require("./../vendor/jaderuntime.js");function template(locals) {
var buf = [];
var jade_mixins = {};
...
},{"./../vendor/jaderuntime.js":20}],18:[function(require,module,exports){
jade = require("./../vendor/jaderuntime.js");function template(locals) {
var buf = [];
var jade_mixins = {};
...
},{"./../vendor/jaderuntime.js":20}],19:[function(require,module,exports){
...
},{"./vendor/moment.js":22}],20:[function(require,module,exports){
...
},{"fs":25}],21:[function(require,module,exports){
